...
Idade (Inteiro)
Dicas:
Você pode criar uma lista para adicionar todos os clientes; pode usar um dicionário para armazenar cada cliente; Você vai obter os dados pela entrada padrão (usando a função input()).
